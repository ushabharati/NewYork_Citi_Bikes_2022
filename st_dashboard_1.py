...
st.markdown("""Citi Bike faces availability issues at certain times. This dashboard aims to identify the potential root causes of bike distribution inefficiencies to ensure optimal availability and improve customer satisfaction.""")
