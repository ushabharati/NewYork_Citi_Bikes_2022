...
if page == "Intro page":
    ...
    st.markdown("#### This dashboard aims to provide helpful insights on the expansion problems NewYork CitiBikes currently faces.")
...
### CONCLUSIONS PAGE: RECOMMENDATIONS
    ...
    bikes = Image.open('https://github.com/ushabharati/NewYork_Citi_Bikes_2022/blob/main/CitiBike_2.JPG?raw=true')  # Source: https://gothamist.com/news/bigger-faster-and-flashier-new-e-bikes-join-citi-bikes-fleet
    st.image(bikes)
